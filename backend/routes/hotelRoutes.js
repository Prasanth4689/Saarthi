...
router.get("/", async (req, res) => {
  try {
    ...
    res.json({
        data: {
            hotel_id: 1,
            hotel_name: "The Grand Fallback Resort",
            photo: { main: "https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
