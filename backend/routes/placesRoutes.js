...
router.get("/", async (req, res) => {
  try {
    ...
    // Fallback Mock Data
    res.json([
      { id: 101, name: "Sunset Point", image: "https://images.unsplash.com/photo-1506462945848-ac8ea6f609cc?w=600&q=80", description: "Scenic views and natural beauty", rating: "4.7", category: "natural", bestTime: "Evening" },
      { id: 102, name: "City Museum", image: "https://images.unsplash.com/photo-1566127444979-b3d2b654e3d7?w=600&q=80", description: "Historical artifacts and culture", rating: "4.5", category: "cultural", bestTime: "Morning" },
      { id: 103, name: "Local Market Square", image: "https://images.unsplash.com/photo-1533900298318-6b8da08a523e?w=600&q=80", description: "Shopping and local street food", rating: "4.3", category: "market", bestTime: "Afternoon" },
      { id: 104, name: "Heritage Temple", image: "https://images.unsplash.com/photo-1514222134-b57cbb8ce073?w=600&q=80", description: "Ancient architecture and spirituality", rating: "4.8", category: "religion", bestTime: "Morning" }
    ]);
  }
});
